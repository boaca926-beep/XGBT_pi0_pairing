...
const TString corr_type = "_";

const TString x_title = "M^{#chi^{2}_{#gamma#gamma}}_{3#pi}";
const TString y_title = "M^{BDT}_{3#pi} ";

const TString x_unit = "[MeV/c^{2}]";
const TString y_unit = "[MeV/c^{2}]";
