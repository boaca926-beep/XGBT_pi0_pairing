...
if __name__ == '__main__':
    ...
    for data_type, info in phys_map.items():
        ...
        if (br_nm  == phys_ch[0]and category == phys_ch[1]):
            ...
            df_set = [all_df.drop(['event', 'Br_betapi0', 'Br_ppIM', 'Br_angle_pi0gam12', 'Br_deltaE', 'Br_m3pi', 'Br_lagvalue_min_7C', 'Br_recon_indx', 'Br_bkg_indx', 'is_signal', 'true_pi0_pair'], axis=1), pos_df, neg_df] 
            ...
            kine_all_df = all_df[['Br_betapi0', 'Br_ppIM', 'Br_angle_pi0gam12', 'Br_deltaE', 'Br_m3pi', 'Br_lagvalue_min_7C', 'is_signal']]
            ...
            ## * Plot kine. var of selection cuts
            ## chi2, gg-opening-angle, deltaE, ppIM, betapi0
            ...
            fig_compr_hist = plot_compr_hist(kine_df_set, 
                                             2, 100, 
                                             rf"Selection Cuts ({br_title})") # Pi0 comparison plot
            ...
            fig_feature_pairs = plot_feature_pairs(kine_all_df, 
            ...
            fig_compr_hist = plot_compr_hist(pi0_df_set, 
                                             2, 100, 
            ...
            pi0_all_df = pi0_all_df.drop(['event', 'cos_theta', 'pair_id'], axis=1)
